...
* Set up for postgres with automigrations thanks to [Gorm](https://github.com/jinzhu/gorm)
...
```
$ git clone git@github.com:andreashart/growth.git $GOPATH/src/github.com/<username>/<project>
...
## Attributes
Combination of https://github.com/olebedev/go-starter-kit and https://github.com/coackroachdb/example-orms/go/gorm
